...
#### what is the general pattern of post replies to the same original forum post creator(i.e. how and how many replies are given to a perosn who asks a question)?
```{r}
